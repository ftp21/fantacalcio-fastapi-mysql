...
def get_rosa(id_squadra) -> Rosa:
    ...
    portieri=_get_rosa_ruolo('P',id_squadra)
    difensori = _get_rosa_ruolo('D',id_squadra)
    centrocampisti = _get_rosa_ruolo('C',id_squadra)
    attaccanti = _get_rosa_ruolo('A',id_squadra)
